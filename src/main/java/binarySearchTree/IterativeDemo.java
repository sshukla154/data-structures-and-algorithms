	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 2:
				...
				x = scanner.nextInt();
				boolean searchResult = binarySearchTree.iterativeSearch(x);
				if (searchResult) {
			...
			case 3:
				...
				x = scanner.nextInt();
				binarySearchTree.iterativeInsert(x);
				break;
			case 4:
				System.out.print("Enter the key to be deleted :");
				x = scanner.nextInt();
				binarySearchTree.iterativeDelete(x);
				break;
			case 5:
			...
			case 8:
				...
				break;
			case 9:
				System.out.println("Minimum key is : " + binarySearchTree.iterativeMin());
				break;
			case 10:
				System.out.println("Maximum key is : " + binarySearchTree.iterativeMax());
				break;
			default:
